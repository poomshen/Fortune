...
public interface IFullCalendar {
	...
	//모든 일반업무 일정내용 호출
	public List<Schedule_Work_Meeting_DTO> selectSWList(String collabo_no, String yearmonth) throws ClassNotFoundException, SQLException;
	public List<Work_Users_DTO> selectWUList(String collabo_no, String yearmonth) throws ClassNotFoundException, SQLException;
	
	//모든 회의업무 일정내용 호출
	public List<Schedule_Work_Meeting_DTO> selectSMList(String collabo_no, String yearmonth) throws ClassNotFoundException, SQLException;
	
	//로그인한 사용자의 일정 보기
	public List<Schedule_Work_Meeting_DTO> selectMySWMList(String collabo_no, String login_id, String yearmonth) throws ClassNotFoundException, SQLException;
