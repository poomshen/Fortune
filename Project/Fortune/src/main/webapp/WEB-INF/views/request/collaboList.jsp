								...
								<div class="accordion">
									...
									<div class="sub-nav active">
										<div class="html about-me" id="about-mesocial-link${req}">
											...
											<h6 style="font-weight: inherit;">예상 수익: ${n.collabo_sal}￦</h6>
											...
											<div class="social-link" id="social-link${req}">
												<a href="schedule.htm?collabo_no=${n.collabo_no}" class="link link-twitter" > 
												<i class="glyphicon glyphicon-calendar"></i><!-- 일정 -->
												</a> 
												<a href="mainfile.htm?collabo_no=${n.collabo_no}" class="link link-twitter" > 
												<i class="glyphicon  glyphicon-cloud"></i><!-- 자료실 -->
												</a> 
												<a onclick="detailReqCollabo(${req})" class="link link-twitter" >
												 <i class="glyphicon  glyphicon-th-list" ></i><!-- 상세보기  -->
												</a> 
												<a href="historyList.htm?collabo_req_no=${n.collabo_req_no }" class="link link-twitter" >
												<i class="glyphicon  glyphicon-th-list"></i><!-- 히스토리 보기 -->
												</a>
											</div>
										</div>
									</div>
