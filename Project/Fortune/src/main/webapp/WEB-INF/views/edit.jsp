...
<body>
	...
	<!-- 		<div class="moco"> -->
        			...
        			<h3 class="modal-title" id="modal-login-label">EDIT</h3>
    			
        			<div class="moco-body">
        			<!-- 	 <div class="container"> -->

<form class="form-horizontal" action="updateConfirm.htm" method="post"  id="contact_form">
<fieldset>
...
<div class="form-group">
  ...
  <div class="col-md-5 inputGroupContainer"  style="margin-left:2%">
	  <div class="input-group">
		  ...
		  <input type="text" id="id" name="id" readonly="readonly" class="form-control hvr-glow" value="${info.id}"><br> 
	  </div>
  </div>
</div>
